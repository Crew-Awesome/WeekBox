...
4. Do not add secrets, downloaded binaries, or unrelated generated files.
5. Putting malicious changes on your pull requests can get you expelled from the WeekBox Project
