// public/launcher/src/ui/engines/index.js
import { FS } from '../../utils/FS.js';

// --- SISTEMA TOAST GLOBAL (Desacoplado) ---
...
// Instanciar Toast Global
new GlobalDownloadToast();

// --- CONTROLADOR DE VISTA ENGINES ---
const EnginesController = {
    ...
    async updateReleaseNotes(versionData) {
        ...
        try {
            ...
            // Saneamiento de seguridad contra inyecciones <script> etc.
