...
export const homeGrid = {
    ...
    get currentPage() { return gridState.currentPage; },
    set currentPage(val) { gridState.currentPage = val; },
    
    get isSearchMode() { return gridState.isSearchMode; },
    set isSearchMode(val) { gridState.isSearchMode = val; },
    
    get searchQuery() { return gridState.searchQuery; },
    set searchQuery(val) { gridState.searchQuery = val; },
