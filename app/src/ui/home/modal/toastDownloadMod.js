export const toastDownloadMod = {
  ...
  show(modId, modName, onCancel) {
    ...
    toastContent
      .querySelector(".toast-mod-collapse")
    ...
    toastContent
      .querySelector(".toast-mod-cancel")
      .addEventListener("click", (e) => {
        e.stopPropagation();
  ...
  success(modId) {
    ...
    toast.elements.statusEl.innerHTML =
      '<i class="fa-solid fa-check" style="margin-right: 6px; color: #fff;"></i><span style="color: #fff;">Installed</span>';
  ...
  cancelAnim(modId) {
    ...
    const interval = setInterval(() => {
      ...
      if (current <= 0) {
        ...
        toast.elements.percentEl.innerHTML =
          '<i class="fa-solid fa-xmark"></i>';
